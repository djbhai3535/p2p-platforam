...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($demoUsers as $du) {
            ...
            // Seed user payment account
            if ($du['country']->iso_code === 'PK') {
                $u->userPaymentMethods()->create([
                    'payment_method_id' => PaymentMethod::where('slug', 'easypaisa')->first()->id,
        ...
        $settings = [
            ...
            // New dynamic help and contact configurations (Phase 9/10)
